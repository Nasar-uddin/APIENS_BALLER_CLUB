        ...
        <div className="row">
          <div className="col-lg-6">
            ...
            <p>
              ...
              privilege. To actually own an original Big Cat is to walk amongst
              virtual gods.
            </p>
            <p>
            ...
            <p>
              ...
              the Metaverse forever. Every Big Cat will be designed by
              world-class artists with savage instincts for detail, quality, and
              adaptability.
            </p>
            <p>
              In a game of cat and mouse, the Big Cat always wins. Now is the
              time. Jump on your chance to own your very own Big Cat.
            </p>
          </div>
          <div className="col-lg-6">
